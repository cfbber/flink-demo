...
import org.apache.shade.kafka.common.Configurable;
import org.apache.shade.kafka.common.KafkaException;
import org.apache.shade.kafka.common.utils.Utils;
import org.apache.shade.kafka.common.config.types.Password;
...
public class AbstractConfig {
    ...
    public AbstractConfig(org.apache.shade.kafka.common.config.ConfigDef definition, Map<?, ?> originals, Boolean doLog) {
        /* check that all the keys are really strings */
        for (Object key : originals.keySet())
            if (!(key instanceof String))
                throw new org.apache.shade.kafka.common.config.ConfigException(key.toString(), originals.get(key), "Key must be a string.");
    ...
    public org.apache.shade.kafka.common.config.types.Password getPassword(String key) {
