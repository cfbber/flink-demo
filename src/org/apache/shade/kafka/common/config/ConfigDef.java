            ...
            switch (type) {
                case BOOLEAN:
                    if (value instanceof String) {
                        ...
                        throw new ConfigException(name, value, "Expected value to be either true or false");
                case PASSWORD:
                    if (value instanceof org.apache.shade.kafka.common.config.types.Password)
                        return value;
                ...
                case CLASS:
                    if (value instanceof Class)
                        ...
                        return Class.forName(trimmed, true, org.apache.shade.kafka.common.utils.Utils.getContextOrKafkaClassLoader());
                    else
    ...
    public static class ValidString implements Validator {
        ...
        public void ensureValid(String name, Object o) {
            ...
            if (!validStrings.contains(s)) {
                throw new ConfigException(name, o, "String must be one of: " + org.apache.shade.kafka.common.utils.Utils.join(validStrings, ", "));
            }
