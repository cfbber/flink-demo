 ...
 */
package org.apache.shade.kafka.common.protocol.types;
...
public class Struct {
     ...
     */
    private Object getFieldOrDefault(org.apache.shade.kafka.common.protocol.types.Field field) {
        Object value = this.values[field.index];
        if (value != null)
            return value;
        else if (field.defaultValue != org.apache.shade.kafka.common.protocol.types.Field.NO_DEFAULT)
     ...
     * @throws SchemaException if the field has no value and has no default.
     */
    public Object get(org.apache.shade.kafka.common.protocol.types.Field field) {
        validateField(field);
    ...
    public Object get(String name) {
        org.apache.shade.kafka.common.protocol.types.Field field = schema.get(name);
        if (field == null)
    ...
    public Struct getStruct(org.apache.shade.kafka.common.protocol.types.Field field) {
    ...
    public Byte getByte(org.apache.shade.kafka.common.protocol.types.Field field) {
    ...
    public Short getShort(org.apache.shade.kafka.common.protocol.types.Field field) {
    ...
    public Integer getInt(org.apache.shade.kafka.common.protocol.types.Field field) {
    ...
    public Long getLong(org.apache.shade.kafka.common.protocol.types.Field field) {
    ...
    public Object[] getArray(org.apache.shade.kafka.common.protocol.types.Field field) {
    ...
    public String getString(org.apache.shade.kafka.common.protocol.types.Field field) {
    ...
    public ByteBuffer getBytes(org.apache.shade.kafka.common.protocol.types.Field field) {
     ...
     */
    public Struct set(org.apache.shade.kafka.common.protocol.types.Field field, Object value) {
        validateField(field);
    ...
    public Struct set(String name, Object value) {
        org.apache.shade.kafka.common.protocol.types.Field field = this.schema.get(name);
        if (field == null)
     ...
     */
    public Struct instance(org.apache.shade.kafka.common.protocol.types.Field field) {
        validateField(field);
        if (field.type() instanceof Schema) {
            return new Struct((Schema) field.type());
        } else if (field.type() instanceof org.apache.shade.kafka.common.protocol.types.ArrayOf) {
            org.apache.shade.kafka.common.protocol.types.ArrayOf array = (org.apache.shade.kafka.common.protocol.types.ArrayOf) field.type();
     ...
     */
    private void validateField(org.apache.shade.kafka.common.protocol.types.Field field) {
    ...
    public String toString() {
        ...
        for (int i = 0; i < this.values.length; i++) {
            org.apache.shade.kafka.common.protocol.types.Field f = this.schema.get(i);
            b.append(f.name);
            b.append('=');
            if (f.type() instanceof org.apache.shade.kafka.common.protocol.types.ArrayOf) {
