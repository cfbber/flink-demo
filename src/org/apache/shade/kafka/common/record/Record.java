...
import org.apache.shade.kafka.common.utils.Crc32;
...
public final class Record {
     ...
     */
    public Record(byte[] key, byte[] value, org.apache.shade.kafka.common.record.CompressionType type, int valueOffset, int valueSize) {
    ...
    public Record(byte[] key, byte[] value, org.apache.shade.kafka.common.record.CompressionType type) {
        this(key, value, type, 0, -1);
    }

    public Record(byte[] value, org.apache.shade.kafka.common.record.CompressionType type) {
        this(null, value, type);
    }

    public Record(byte[] key, byte[] value) {
        this(key, value, org.apache.shade.kafka.common.record.CompressionType.NONE);
    }

    public Record(byte[] value) {
        this(null, value, org.apache.shade.kafka.common.record.CompressionType.NONE);
    }

    // Write a record to the buffer, if the record's compression type is none, then
    // its value payload should be already compressed with the specified type
    public static void write(ByteBuffer buffer, byte[] key, byte[] value, org.apache.shade.kafka.common.record.CompressionType type, int valueOffset, int valueSize) {
        ...
        org.apache.shade.kafka.common.record.Compressor compressor = new org.apache.shade.kafka.common.record.Compressor(buffer, org.apache.shade.kafka.common.record.CompressionType.NONE, buffer.capacity());
    ...
    public static byte computeAttributes(org.apache.shade.kafka.common.record.CompressionType type) {
        byte attributes = 0;
        if (type.id > 0)
     ...
     */
    public static long computeChecksum(byte[] key, byte[] value, org.apache.shade.kafka.common.record.CompressionType type, int valueOffset, int valueSize) {
        Crc32 crc = new Crc32();
     ...
     */
    public org.apache.shade.kafka.common.record.CompressionType compressionType() {
