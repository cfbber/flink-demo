...
public class OffsetCommitRequest extends AbstractRequest {
    ...
    private static final org.apache.shade.kafka.common.protocol.types.Schema CURRENT_SCHEMA = ProtoUtils.currentRequestSchema(ApiKeys.OFFSET_COMMIT.id);
    ...
    public OffsetCommitRequest(String groupId, Map<TopicPartition, PartitionData> offsetData) {
        super(new org.apache.shade.kafka.common.protocol.types.Struct(ProtoUtils.requestSchema(ApiKeys.OFFSET_COMMIT.id, 0)));
    ...
    public OffsetCommitRequest(String groupId, int generationId, String memberId, Map<TopicPartition, PartitionData> offsetData) {
        super(new org.apache.shade.kafka.common.protocol.types.Struct(ProtoUtils.requestSchema(ApiKeys.OFFSET_COMMIT.id, 1)));
    ...
    public OffsetCommitRequest(org.apache.shade.kafka.common.protocol.types.Struct struct) {
        super(struct);
        ...
        for (Object topicDataObj : struct.getArray(TOPICS_KEY_NAME)) {
            org.apache.shade.kafka.common.protocol.types.Struct topicData = (org.apache.shade.kafka.common.protocol.types.Struct) topicDataObj;
            String topic = topicData.getString(TOPIC_KEY_NAME);
            for (Object partitionDataObj : topicData.getArray(PARTITIONS_KEY_NAME)) {
                org.apache.shade.kafka.common.protocol.types.Struct partitionDataStruct = (org.apache.shade.kafka.common.protocol.types.Struct) partitionDataObj;
    ...
    public static OffsetCommitRequest parse(ByteBuffer buffer, int versionId) {
        ...
        return new OffsetCommitRequest((org.apache.shade.kafka.common.protocol.types.Struct) schema.read(buffer));
    }
