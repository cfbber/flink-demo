...
public class ListGroupsResponse extends AbstractRequestResponse {
    ...
    public ListGroupsResponse(short errorCode, List<Group> groups) {
        ...
        List<org.apache.shade.kafka.common.protocol.types.Struct> groupList = new ArrayList<>();
    ...
    public ListGroupsResponse(org.apache.shade.kafka.common.protocol.types.Struct struct) {
        super(struct);
