...
public class JoinGroupResponse extends AbstractRequestResponse {
    ...
    public JoinGroupResponse(short errorCode,
        ...
        List<org.apache.shade.kafka.common.protocol.types.Struct> memberArray = new ArrayList<>();
        for (Map.Entry<String, ByteBuffer> entries: groupMembers.entrySet()) {
            org.apache.shade.kafka.common.protocol.types.Struct memberData = struct.instance(MEMBERS_KEY_NAME);
    ...
    public JoinGroupResponse(org.apache.shade.kafka.common.protocol.types.Struct struct) {
        super(struct);
        members = new HashMap<>();

        for (Object memberDataObj : struct.getArray(MEMBERS_KEY_NAME)) {
            org.apache.shade.kafka.common.protocol.types.Struct memberData = (org.apache.shade.kafka.common.protocol.types.Struct) memberDataObj;
