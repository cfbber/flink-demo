...
public class DescribeGroupsResponse extends AbstractRequestResponse {
    ...
    public DescribeGroupsResponse(Map<String, GroupMetadata> groups) {
        ...
        List<org.apache.shade.kafka.common.protocol.types.Struct> groupStructs = new ArrayList<>();
        for (Map.Entry<String, GroupMetadata> groupEntry : groups.entrySet()) {
            org.apache.shade.kafka.common.protocol.types.Struct groupStruct = struct.instance(GROUPS_KEY_NAME);
            ...
            List<org.apache.shade.kafka.common.protocol.types.Struct> membersList = new ArrayList<>();
            for (GroupMember member : group.members) {
                org.apache.shade.kafka.common.protocol.types.Struct memberStruct = groupStruct.instance(MEMBERS_KEY_NAME);
    ...
    public DescribeGroupsResponse(org.apache.shade.kafka.common.protocol.types.Struct struct) {
        super(struct);
        this.groups = new HashMap<>();
        for (Object groupObj : struct.getArray(GROUPS_KEY_NAME)) {
            org.apache.shade.kafka.common.protocol.types.Struct groupStruct = (org.apache.shade.kafka.common.protocol.types.Struct) groupObj;
            ...
            for (Object memberObj : groupStruct.getArray(MEMBERS_KEY_NAME)) {
                org.apache.shade.kafka.common.protocol.types.Struct memberStruct = (org.apache.shade.kafka.common.protocol.types.Struct) memberObj;
