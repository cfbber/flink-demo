...
public class SyncGroupRequest extends AbstractRequest {
    ...
    public SyncGroupRequest(String groupId,
        ...
        for (Map.Entry<String, ByteBuffer> entries: groupAssignment.entrySet()) {
            org.apache.shade.kafka.common.protocol.types.Struct memberData = struct.instance(GROUP_ASSIGNMENT_KEY_NAME);
    ...
    public SyncGroupRequest(org.apache.shade.kafka.common.protocol.types.Struct struct) {
        super(struct);
        ...
        for (Object memberDataObj : struct.getArray(GROUP_ASSIGNMENT_KEY_NAME)) {
            org.apache.shade.kafka.common.protocol.types.Struct memberData = (Struct) memberDataObj;
