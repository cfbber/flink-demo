...
import static org.apache.shade.kafka.common.protocol.Protocol.REQUEST_HEADER;
...
public class RequestHeader extends AbstractRequestResponse {
    ...
    private static final org.apache.shade.kafka.common.protocol.types.Field API_KEY_FIELD = REQUEST_HEADER.get("api_key");
    private static final org.apache.shade.kafka.common.protocol.types.Field API_VERSION_FIELD = REQUEST_HEADER.get("api_version");
    private static final org.apache.shade.kafka.common.protocol.types.Field CLIENT_ID_FIELD = REQUEST_HEADER.get("client_id");
    ...
    public RequestHeader(org.apache.shade.kafka.common.protocol.types.Struct header) {
        super(header);
    ...
    public RequestHeader(short apiKey, short version, String client, int correlation) {
        super(new org.apache.shade.kafka.common.protocol.types.Struct(Protocol.REQUEST_HEADER));
