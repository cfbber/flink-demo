...
public class StopReplicaRequest extends AbstractRequest {
    ...
    public StopReplicaRequest(int controllerId, int controllerEpoch, boolean deletePartitions, Set<TopicPartition> partitions) {
        ...
        List<org.apache.shade.kafka.common.protocol.types.Struct> partitionDatas = new ArrayList<>(partitions.size());
    ...
    public StopReplicaRequest(org.apache.shade.kafka.common.protocol.types.Struct struct) {
        super(struct);

        partitions = new HashSet<>();
        for (Object partitionDataObj : struct.getArray(PARTITIONS_KEY_NAME)) {
            org.apache.shade.kafka.common.protocol.types.Struct partitionData = (org.apache.shade.kafka.common.protocol.types.Struct) partitionDataObj;
