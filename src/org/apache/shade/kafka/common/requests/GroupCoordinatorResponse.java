...
public class GroupCoordinatorResponse extends AbstractRequestResponse {
    ...
    public GroupCoordinatorResponse(short errorCode, Node node) {
        ...
        org.apache.shade.kafka.common.protocol.types.Struct coordinator = struct.instance(COORDINATOR_KEY_NAME);
    ...
    public GroupCoordinatorResponse(org.apache.shade.kafka.common.protocol.types.Struct struct) {
        super(struct);
        errorCode = struct.getShort(ERROR_CODE_KEY_NAME);
        org.apache.shade.kafka.common.protocol.types.Struct broker = (org.apache.shade.kafka.common.protocol.types.Struct) struct.get(COORDINATOR_KEY_NAME);
