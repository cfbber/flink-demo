...
public class FetchResponse extends AbstractRequestResponse {
  ...
  /**
    ...
    public FetchResponse(Map<TopicPartition, PartitionData> responseData) {
        super(new org.apache.shade.kafka.common.protocol.types.Struct(ProtoUtils.responseSchema(ApiKeys.FETCH.id, 0)));
   ...
   */
    ...
    public FetchResponse(org.apache.shade.kafka.common.protocol.types.Struct struct) {
        super(struct);
    ...
    public static FetchResponse parse(ByteBuffer buffer) {
        return new FetchResponse((org.apache.shade.kafka.common.protocol.types.Struct) CURRENT_SCHEMA.read(buffer));
    }
