...
public class ProduceResponse extends AbstractRequestResponse {
    ...
    public ProduceResponse(Map<TopicPartition, PartitionResponse> responses) {
        super(new org.apache.shade.kafka.common.protocol.types.Struct(ProtoUtils.responseSchema(ApiKeys.PRODUCE.id, 0)));
    ...
    public ProduceResponse(org.apache.shade.kafka.common.protocol.types.Struct struct) {
        super(struct);
        responses = new HashMap<TopicPartition, PartitionResponse>();
        for (Object topicResponse : struct.getArray(RESPONSES_KEY_NAME)) {
            org.apache.shade.kafka.common.protocol.types.Struct topicRespStruct = (org.apache.shade.kafka.common.protocol.types.Struct) topicResponse;
            ...
            for (Object partResponse : topicRespStruct.getArray(PARTITION_RESPONSES_KEY_NAME)) {
                org.apache.shade.kafka.common.protocol.types.Struct partRespStruct = (org.apache.shade.kafka.common.protocol.types.Struct) partResponse;
    ...
    private void initCommonFields(Map<TopicPartition, PartitionResponse> responses) {
        ...
        List<org.apache.shade.kafka.common.protocol.types.Struct> topicDatas = new ArrayList<org.apache.shade.kafka.common.protocol.types.Struct>(responseByTopic.size());
        for (Map.Entry<String, Map<Integer, PartitionResponse>> entry : responseByTopic.entrySet()) {
            ...
            for (Map.Entry<Integer, PartitionResponse> partitionEntry : entry.getValue().entrySet()) {
                ...
                org.apache.shade.kafka.common.protocol.types.Struct partStruct = topicData.instance(PARTITION_RESPONSES_KEY_NAME).set(PARTITION_KEY_NAME,
