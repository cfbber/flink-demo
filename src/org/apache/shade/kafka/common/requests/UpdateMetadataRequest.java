...
public class UpdateMetadataRequest extends AbstractRequest {
    ...
    private UpdateMetadataRequest(int version, int controllerId, int controllerEpoch, Map<TopicPartition,
            PartitionState> partitionStates, Set<Broker> liveBrokers) {
        super(new org.apache.shade.kafka.common.protocol.types.Struct(ProtoUtils.requestSchema(ApiKeys.UPDATE_METADATA_KEY.id, version)));
        ...
        List<org.apache.shade.kafka.common.protocol.types.Struct> brokersData = new ArrayList<>(liveBrokers.size());
        for (Broker broker : liveBrokers) {
            org.apache.shade.kafka.common.protocol.types.Struct brokerData = struct.instance(LIVE_BROKERS_KEY_NAME);
            ...
            if (version == 0) {
                ...
                List<org.apache.shade.kafka.common.protocol.types.Struct> endPointsData = new ArrayList<>(broker.endPoints.size());
                for (Map.Entry<SecurityProtocol, EndPoint> entry : broker.endPoints.entrySet()) {
                    org.apache.shade.kafka.common.protocol.types.Struct endPointData = brokerData.instance(ENDPOINTS_KEY_NAME);
    ...
    public UpdateMetadataRequest(org.apache.shade.kafka.common.protocol.types.Struct struct) {
        super(struct);
        ...
        for (Object brokerDataObj : struct.getArray(LIVE_BROKERS_KEY_NAME)) {
            org.apache.shade.kafka.common.protocol.types.Struct brokerData = (org.apache.shade.kafka.common.protocol.types.Struct) brokerDataObj;
            ...
            if (brokerData.hasField(HOST_KEY_NAME)) {
                ...
                for (Object endPointDataObj : brokerData.getArray(ENDPOINTS_KEY_NAME)) {
                    org.apache.shade.kafka.common.protocol.types.Struct endPointData = (org.apache.shade.kafka.common.protocol.types.Struct) endPointDataObj;
