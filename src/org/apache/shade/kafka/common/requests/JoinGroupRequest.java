...
public class JoinGroupRequest extends AbstractRequest {
    ...
    public JoinGroupRequest(String groupId,
        ...
        List<org.apache.shade.kafka.common.protocol.types.Struct> groupProtocolsList = new ArrayList<>();
        for (ProtocolMetadata protocol : groupProtocols) {
            org.apache.shade.kafka.common.protocol.types.Struct protocolStruct = struct.instance(GROUP_PROTOCOLS_KEY_NAME);
    ...
    public JoinGroupRequest(org.apache.shade.kafka.common.protocol.types.Struct struct) {
        super(struct);
        ...
        for (Object groupProtocolObj : struct.getArray(GROUP_PROTOCOLS_KEY_NAME)) {
            org.apache.shade.kafka.common.protocol.types.Struct groupProtocolStruct = (org.apache.shade.kafka.common.protocol.types.Struct) groupProtocolObj;
