...
package org.apache.shade.kafka.common.cache;
 ...
 */
public class SynchronizedCache<K, V> implements org.apache.shade.kafka.common.cache.Cache<K, V> {
    private final org.apache.shade.kafka.common.cache.Cache<K, V> underlying;
