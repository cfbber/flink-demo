...
public final class MetricName {
    ...
    public MetricName(String name, String group, String description, Map<String, String> tags) {
        this.name = org.apache.shade.kafka.common.utils.Utils.notNull(name);
        this.group = org.apache.shade.kafka.common.utils.Utils.notNull(group);
        this.description = org.apache.shade.kafka.common.utils.Utils.notNull(description);
