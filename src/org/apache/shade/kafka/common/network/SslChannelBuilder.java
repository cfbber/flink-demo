...
public class SslChannelBuilder implements ChannelBuilder {
    ...
    private org.apache.shade.kafka.common.network.Mode mode;
    ...
    public void configure(Map<String, ?> configs) throws KafkaException {
        try {
            ...
            this.sslFactory = new org.apache.shade.kafka.common.security.ssl.SslFactory(mode);
    ...
    public org.apache.shade.kafka.common.network.KafkaChannel buildChannel(String id, SelectionKey key, int maxReceiveSize) throws KafkaException {
        org.apache.shade.kafka.common.network.KafkaChannel channel = null;
        try {
