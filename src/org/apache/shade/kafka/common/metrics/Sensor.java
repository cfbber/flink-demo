...
public final class Sensor {
    ...
    private final org.apache.shade.kafka.common.metrics.Metrics registry;
    private final String name;
    private final Sensor[] parents;
    private final List<Stat> stats;
    private final List<org.apache.shade.kafka.common.metrics.KafkaMetric> metrics;
    ...
    Sensor(Metrics registry, String name, Sensor[] parents, org.apache.shade.kafka.common.metrics.MetricConfig config, Time time, long inactiveSensorExpirationTimeSeconds) {
        super();
     ...
     * @throws org.apache.shade.kafka.common.metrics.QuotaViolationException if recording this value moves a metric beyond its configured maximum or minimum
     *         bound
     */
    ...
    private void checkQuotas(long timeMs) {
        for (int i = 0; i < this.metrics.size(); i++) {
            org.apache.shade.kafka.common.metrics.KafkaMetric metric = this.metrics.get(i);
            org.apache.shade.kafka.common.metrics.MetricConfig config = metric.config();
            if (config != null) {
     ...
     */
    public void add(org.apache.shade.kafka.common.metrics.CompoundStat stat) {
        add(stat, null);
    }
     ...
     *        sensor.
     */
    public synchronized void add(CompoundStat stat, org.apache.shade.kafka.common.metrics.MetricConfig config) {
        this.stats.add(Utils.notNull(stat));
        for (NamedMeasurable m : stat.stats()) {
            org.apache.shade.kafka.common.metrics.KafkaMetric metric = new org.apache.shade.kafka.common.metrics.KafkaMetric(this, m.name(), m.stat(), config == null ? this.config : config, time);
     ...
     */
    public void add(MetricName metricName, org.apache.shade.kafka.common.metrics.MeasurableStat stat) {
    ...
    public synchronized void add(MetricName metricName, MeasurableStat stat, MetricConfig config) {
        org.apache.shade.kafka.common.metrics.KafkaMetric metric = new org.apache.shade.kafka.common.metrics.KafkaMetric(new Object(),
