...
import org.apache.shade.kafka.common.metrics.CompoundStat;
import org.apache.shade.kafka.common.metrics.Measurable;
import org.apache.shade.kafka.common.metrics.MetricConfig;
import org.apache.shade.kafka.common.metrics.stats.Histogram.BinScheme;
import org.apache.shade.kafka.common.metrics.stats.Histogram.ConstantBinScheme;
import org.apache.shade.kafka.common.metrics.stats.Histogram.LinearBinScheme;
...
public class Percentiles extends SampledStat implements CompoundStat {
    ...
    private static class HistogramSample extends SampledStat.Sample {
        private final org.apache.shade.kafka.common.metrics.stats.Histogram histogram;
