...
import org.apache.shade.kafka.clients.consumer.CommitFailedException;
...
import org.apache.shade.kafka.common.errors.GroupAuthorizationException;
...
import org.apache.shade.kafka.common.requests.JoinGroupRequest.ProtocolMetadata;
import org.apache.shade.kafka.common.requests.OffsetCommitRequest;
import org.apache.shade.kafka.common.requests.OffsetCommitResponse;
import org.apache.shade.kafka.common.requests.OffsetFetchRequest;
import org.apache.shade.kafka.common.requests.OffsetFetchResponse;
...
public final class ConsumerCoordinator extends AbstractCoordinator {
    ...
    public String protocolType() {
        return org.apache.shade.kafka.clients.consumer.internals.ConsumerProtocol.PROTOCOL_TYPE;
    }
    ...
    public List<ProtocolMetadata> metadata() {
        ...
        for (PartitionAssignor assignor : assignors) {
            PartitionAssignor.Subscription subscription = assignor.subscription(subscriptions.subscription());
            ByteBuffer metadata = org.apache.shade.kafka.clients.consumer.internals.ConsumerProtocol.serializeSubscription(subscription);
    ...
    protected void onJoinComplete(int generation,
        ...
        PartitionAssignor.Assignment assignment = org.apache.shade.kafka.clients.consumer.internals.ConsumerProtocol.deserializeAssignment(assignmentBuffer);
    ...
    protected Map<String, ByteBuffer> performAssignment(String leaderId,
        ...
        for (Map.Entry<String, ByteBuffer> subscriptionEntry : allSubscriptions.entrySet()) {
            PartitionAssignor.Subscription subscription = org.apache.shade.kafka.clients.consumer.internals.ConsumerProtocol.deserializeSubscription(subscriptionEntry.getValue());
        ...
        Map<String, PartitionAssignor.Assignment> assignment = assignor.assign(metadata.fetch(), subscriptions);
