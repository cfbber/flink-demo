...
/**
 * A mock of the {@link org.apache.shade.kafka.clients.consumer.Consumer} interface you can use for testing code that uses Kafka. This class is <i> not
...
public class MockConsumer<K, V> implements Consumer<K, V> {
    ...
    @Override
    public void subscribe(Pattern pattern, final org.apache.shade.kafka.clients.consumer.ConsumerRebalanceListener listener) {
        ensureNotClosed();
