...
import org.apache.shade.kafka.clients.producer.internals.ProduceRequestResult;
...
public class MockProducer<K, V> implements Producer<K, V> {
    ...
    private final org.apache.shade.kafka.common.Cluster cluster;
     ...
     */
    public MockProducer(org.apache.shade.kafka.common.Cluster cluster, boolean autoComplete, org.apache.shade.kafka.clients.producer.Partitioner partitioner, Serializer<K> keySerializer, Serializer<V> valueSerializer) {
     ...
     *
     * Equivalent to {@link #MockProducer(org.apache.shade.kafka.common.Cluster, boolean, org.apache.shade.kafka.clients.producer.Partitioner, Serializer, Serializer)} new MockProducer(Cluster.empty(), autoComplete, new DefaultPartitioner(), keySerializer, valueSerializer)}
     */
    public MockProducer(boolean autoComplete, Serializer<K> keySerializer, Serializer<V> valueSerializer) {
        this(org.apache.shade.kafka.common.Cluster.empty(), autoComplete, new DefaultPartitioner(), keySerializer, valueSerializer);
    }

    /**
     * Create a new mock producer with invented metadata the given autoComplete setting, partitioner and key\value serializers
     *
     * Equivalent to {@link #MockProducer(org.apache.shade.kafka.common.Cluster, boolean, org.apache.shade.kafka.clients.producer.Partitioner, Serializer, Serializer)} new MockProducer(Cluster.empty(), autoComplete, partitioner, keySerializer, valueSerializer)}
     */
    public MockProducer(boolean autoComplete, Partitioner partitioner, Serializer<K> keySerializer, Serializer<V> valueSerializer) {
        this(org.apache.shade.kafka.common.Cluster.empty(), autoComplete, partitioner, keySerializer, valueSerializer);
    }
    ...
    public synchronized Future<RecordMetadata> send(ProducerRecord<K, V> record, Callback callback) {
        ...
        org.apache.shade.kafka.clients.producer.internals.ProduceRequestResult result = new org.apache.shade.kafka.clients.producer.internals.ProduceRequestResult();
        org.apache.shade.kafka.clients.producer.internals.FutureRecordMetadata future = new FutureRecordMetadata(result, 0);
     ...
     */
    private int partition(ProducerRecord<K, V> record, org.apache.shade.kafka.common.Cluster cluster) {
