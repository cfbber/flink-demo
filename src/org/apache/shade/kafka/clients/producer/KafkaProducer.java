...
import org.apache.shade.kafka.common.errors.ApiException;
import org.apache.shade.kafka.common.errors.InterruptException;
import org.apache.shade.kafka.common.errors.RecordTooLargeException;
import org.apache.shade.kafka.common.errors.SerializationException;
...
import org.apache.shade.kafka.common.utils.KafkaThread;
import org.apache.shade.kafka.common.utils.SystemTime;
import org.apache.shade.kafka.common.utils.Time;
import org.apache.shade.kafka.clients.producer.internals.RecordAccumulator;
import org.apache.shade.kafka.clients.producer.internals.Sender;
import org.apache.shade.kafka.common.serialization.StringSerializer;
 ...
 * props.put("key.serializer", "org.apache.shade.kafka.common.serialization.StringSerializer");
 * props.put("value.serializer", "org.apache.shade.kafka.common.serialization.StringSerializer");
 *
...
public class KafkaProducer<K, V> implements Producer<K, V> {
    ...
    private final org.apache.shade.kafka.clients.producer.Partitioner partitioner;
    private final int maxRequestSize;
    private final long totalMemorySize;
    private final Metadata metadata;
    private final org.apache.shade.kafka.clients.producer.internals.RecordAccumulator accumulator;
    private final org.apache.shade.kafka.clients.producer.internals.Sender sender;
    ...
    private KafkaProducer(ProducerConfig config, Serializer<K> keySerializer, Serializer<V> valueSerializer) {
        try {
            ...
            this.accumulator = new org.apache.shade.kafka.clients.producer.internals.RecordAccumulator(config.getInt(ProducerConfig.BATCH_SIZE_CONFIG),
     ...
     * See {@link #send(ProducerRecord, org.apache.shade.kafka.clients.producer.Callback)} for details.
     */
    @Override
     ...
     * }</pre>
     * <p>
     * Fully non-blocking usage can make use of the {@link org.apache.shade.kafka.clients.producer.Callback} parameter to provide a callback that
     ...
     * @throws org.apache.shade.kafka.clients.producer.BufferExhaustedException If <code>block.on.buffer.full=false</code> and the buffer is full.
     *
     */
    @Override
    public Future<RecordMetadata> send(ProducerRecord<K, V> record, org.apache.shade.kafka.clients.producer.Callback callback) {
        try {
     ...
     * <p>
     * <strong>If close() is called from {@link org.apache.shade.kafka.clients.producer.Callback}, a warning message will be logged and close(0, TimeUnit.MILLISECONDS)
