...
import static org.apache.shade.net.jpountz.lz4.LZ4BlockOutputStream.COMPRESSION_LEVEL_BASE;
import static org.apache.shade.net.jpountz.lz4.LZ4BlockOutputStream.COMPRESSION_METHOD_LZ4;
import static org.apache.shade.net.jpountz.lz4.LZ4BlockOutputStream.COMPRESSION_METHOD_RAW;
import static org.apache.shade.net.jpountz.lz4.LZ4BlockOutputStream.DEFAULT_SEED;
import static org.apache.shade.net.jpountz.lz4.LZ4BlockOutputStream.HEADER_LENGTH;
import static org.apache.shade.net.jpountz.lz4.LZ4BlockOutputStream.MAGIC;
import static org.apache.shade.net.jpountz.lz4.LZ4BlockOutputStream.MAGIC_LENGTH;
 ...
 * {@link org.apache.shade.net.jpountz.lz4.LZ4BlockOutputStream}. This class is not thread-safe and does not
...
public final class LZ4BlockInputStream extends FilterInputStream {
  ...
  private void refill() throws IOException {
    ...
    final int compressedLen = org.apache.shade.net.jpountz.util.Utils.readIntLE(compressedBuffer, MAGIC_LENGTH + 1);
    originalLen = org.apache.shade.net.jpountz.util.Utils.readIntLE(compressedBuffer, MAGIC_LENGTH + 5);
