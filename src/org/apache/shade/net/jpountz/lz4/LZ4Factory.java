...
public final class LZ4Factory {
  ...
  private final org.apache.shade.net.jpountz.lz4.LZ4Compressor fastCompressor;
  private final org.apache.shade.net.jpountz.lz4.LZ4Compressor highCompressor;
  ...
  private LZ4Factory(String impl) throws ClassNotFoundException, NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException {
    ...
    for (org.apache.shade.net.jpountz.lz4.LZ4Compressor compressor : Arrays.asList(fastCompressor, highCompressor)) {
  ...
  /** Return a blazing fast {@link org.apache.shade.net.jpountz.lz4.LZ4Compressor}. */
  public org.apache.shade.net.jpountz.lz4.LZ4Compressor fastCompressor() {
    return fastCompressor;
  }

  /** Return a {@link org.apache.shade.net.jpountz.lz4.LZ4Compressor} which requires more memory than
