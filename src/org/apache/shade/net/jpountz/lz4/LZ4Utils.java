...
import static org.apache.shade.net.jpountz.lz4.LZ4Constants.HASH_LOG;
import static org.apache.shade.net.jpountz.lz4.LZ4Constants.HASH_LOG_64K;
import static org.apache.shade.net.jpountz.lz4.LZ4Constants.HASH_LOG_HC;
import static org.apache.shade.net.jpountz.lz4.LZ4Constants.LAST_LITERALS;
import static org.apache.shade.net.jpountz.lz4.LZ4Constants.MIN_MATCH;
import static org.apache.shade.net.jpountz.lz4.LZ4Constants.ML_BITS;
import static org.apache.shade.net.jpountz.lz4.LZ4Constants.ML_MASK;
import static org.apache.shade.net.jpountz.lz4.LZ4Constants.RUN_MASK;
import static org.apache.shade.net.jpountz.util.Utils.readInt;
...
enum LZ4Utils {
  ...
  static void wildArraycopy(byte[] src, int sOff, byte[] dest, int dOff, int len) {
    try {
      ...
      throw new org.apache.shade.net.jpountz.lz4.LZ4Exception("Malformed input at offset " + sOff);
    }
  }
  ...
  static int encodeSequence(byte[] src, int anchor, int matchOff, int matchRef, int matchLen, byte[] dest, int dOff, int destEnd) {
    ...
    if (dOff + runLen + (2 + 1 + LAST_LITERALS) + (runLen >>> 8) > destEnd) {
      throw new org.apache.shade.net.jpountz.lz4.LZ4Exception("maxDestLen is too small");
    }
