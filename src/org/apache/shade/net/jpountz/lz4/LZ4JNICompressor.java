 ...
 */
final class LZ4JNICompressor extends org.apache.shade.net.jpountz.lz4.LZ4Compressor {
  ...
  public int compress(byte[] src, int srcOff, int srcLen, byte[] dest, int destOff, int maxDestLen) {
    ...
    final int result = org.apache.shade.net.jpountz.lz4.LZ4JNI.LZ4_compress_limitedOutput(src, srcOff, srcLen, dest, destOff, maxDestLen);
    if (result <= 0) {
